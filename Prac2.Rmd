...
Grupo: Mujeres y hombres (por género)
Grupo:  (por PClase)
Grupo: 
Grupo: 
...
También aplicamos el test de Shappiro-Wilk para la variable Fare. Se vuelve a obtener un p-valor inferior al test de significancia por lo que también podemos determinar que la variable Age no sigue una distribución normal.
